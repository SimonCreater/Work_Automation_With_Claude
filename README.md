...
> 수업에서 배운 분석·설계 산출물(유스케이스·DFD·ERD)에 맞춰 구현했습니다.
...
| S1 | 시스템 요청서 | — |
| S2 | 요구사항 정의 (기능 + 비기능) | — |
| S3 | 유스케이스 2건 (정상 + 예외 흐름) | ch04 Use Case |
| S4 | 구조 다이어그램 / DFD | ch05 Process Modeling |
| S5 | ERD | ch06 Data Modeling |
...
demo/
  run1-equity-research/     # 본인 아이디어: 세션 로그 + 산출물 6종
  run2-*/                   # 다른 도메인 무수정 재적용 + 회고
```
